...
(1003, 'AC-103-1', 'NORMAL',            NULL,    '2025-08-06', 'PRODUCCION', NULL,        103, 303), -- pendiente
...
(1006, 3, '2025-08-09', 'CONTADO', 850.00, 'PARCIALMENTE_PAGADO', 850.00),
(1009, 4, '2025-08-10', 'CREDITO', 300.00, 'PARCIALMENTE_PAGADO', 300.00),
(1010, 5, '2025-08-10', 'CONTADO', 390.00, 'PARCIALMENTE_PAGADO', 390.00);
...
SELECT
  ...
  CASE WHEN f.EstadoAutorizacionSRI IS NULL THEN 'PENDIENTE' ELSE f.EstadoAutorizacionSRI END AS EstadoAutorizacionSRI,
...
BEGIN
    ...
    END IF;
    SELECT Departamento INTO v_dep_sis
    FROM Encargado WHERE CodigoEncargado = NEW.CodigoEncargadoSistemas;
    ...
    END IF;
    SELECT Departamento INTO v_dep_con
    FROM Encargado WHERE CodigoEncargado = NEW.CodigoEncargadoContabilidad;
